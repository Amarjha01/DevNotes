...
export function Header() {
  ...
  return (
    <header className={`fixed top-0  w-full z-50 transition-all duration-500 max-w-[1424px] m-auto ${
      ...
      <div className="flex items-center justify-between px-6 py-4 transition-all duration-300 h-20">
        ...
        >
          <div className="relative">
            <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-purple-400/30 group-hover:border-purple-400/60 transition-all duration-300 shadow-lg">
              <img 
        ...
        <button
          className="lg:hidden relative w-10 text-6xl h-32 bg-gray-900/50 backdrop-blur-sm rounded-full flex items-center justify-center text-purple-400  z-50 hover:bg-gray-800/50 transition-all duration-300 hover:scale-110"
        ...
        {/* Mobile Menu */}
        {menuOpen && (
          <div className="fixed top-3/4 right-0 bg-[#0a0415]/95 pb-5 backdrop-blur-xl flex flex-col items-center justify-center space-y-8 z-40">
            {/* Background Effects */}
            <div className="">
