const qaData = [
    ...
    // ===== DEVOPS =====
    {
        ...
        keywords: ["DevOps", "devops", "Devops", "dev ops"],
        answer: "DevOps is a set of practices that automates and integrates the work of software development and IT operations teams to deliver applications faster and more reliably.",
        link: "/devops/intro",
    },
    {
        question: "What is CI/CD?",
        keywords: ["ci", "cd", "continuous integration", "deployment"],
        answer: "CI/CD automates integration and deployment of software.",
        link: "/devops/cicd",
    },
    {
        question: "What is Docker?",
        keywords: ["docker", "container"],
        answer: "Docker is a platform to build, deploy, and run applications inside containers.",
        link: "/devops/docker",
    },
    {
        question: "What is Kubernetes?",
        keywords: ["kubernetes", "k8s"],
        answer: "Kubernetes is a container orchestration platform for automating deployment and scaling.",
        link: "/devops/kubernetes",
    },
    {
        question: "What is Terraform?",
        keywords: ["terraform", "iac", "infrastructure as code"],
        answer: "Terraform is an Infrastructure as Code tool that allows you to provision cloud resources.",
        link: "/devops/terraform",
    },
    {
        question: "What is Monitoring in DevOps?",
        keywords: ["monitoring", "observability"],
        answer: "Monitoring in DevOps tracks the performance and health of systems and applications.",
        link: "/devops/monitoring",
    },
    {
        question: "What is Deployment in DevOps?",
        keywords: ["deployment", "release"],
        answer: "Deployment is the process of delivering applications or updates to production environments.",
        link: "/devops/deployment",
    },
    {
        question: "What is Cloud in DevOps?",
        keywords: ["cloud", "cloud computing"],
        answer: "Cloud in DevOps refers to using cloud providers like AWS, GCP, or Azure for deploying and scaling apps.",
        link: "/devops/cloud",
    },
    // ===== FRONTEND =====
    {
    ...
    // ===== GEN AI TOOLS =====
    {
        question: "What are Gen-AI Tools?",
        keywords: ["gen ai tools", "ai tools"],
        answer: "Gen-AI Tools are AI-powered tools that assist in frontend, backend, ML, and Android development.",
        link: "/GenAI-Tools",
    },
    {
        question: "What are Frontend Gen-AI Tools?",
        keywords: ["frontend ai", "frontend tools"],
        answer: "Frontend Gen-AI Tools help build and optimize frontend applications.",
        link: "/GenAI-Tools/FrontEndTools",
    },
    {
        question: "What are Backend Gen-AI Tools?",
        keywords: ["backend ai", "backend tools"],
        answer: "Backend Gen-AI Tools assist in generating APIs, backend logic, and optimizations.",
        link: "/GenAI-Tools/BackEndTools",
    },
    {
        question: "What are ML Gen-AI Tools?",
        keywords: ["ml tools", "ml ai tools"],
        answer: "ML Gen-AI Tools help with model building, training, and deployment.",
        link: "/GenAI-Tools/MLTools",
    },
    {
        question: "What are Android Dev Gen-AI Tools?",
        keywords: ["android ai tools", "android genai"],
        answer: "Android Gen-AI Tools assist in building Android apps with AI support.",
        link: "/GenAI-Tools/AndroidDevTools",
    },
    // ===== SYSTEM DESIGN =====
    {
    ...
    // ===== MISCELLANEOUS =====
    {
        ...
        link: "/miscellaneous/git",
    },
    {
        question: "What is Testing?",
        keywords: ["testing", "qa"],
        answer: "Software Testing ensures that applications are working correctly and free of bugs.",
        link: "/miscellaneous/testing",
    },
    {
        question: "What are Package Managers?",
        keywords: ["package manager", "npm", "yarn"],
        answer: "Package managers like npm or yarn manage project dependencies and libraries.",
        link: "/miscellaneous/packagemanagers",
    },
    {
        question: "What is Web Performance?",
        keywords: ["web performance", "optimization"],
        answer: "Web performance ensures websites load quickly and efficiently.",
        link: "/miscellaneous/webperformance",
    },
    {
        ...
        link: "/miscellaneous/accessibility",
    },

    // ===== PROJECTS / DIGEST =====
    {
        question: "Where can I find projects?",
        keywords: ["projects", "project ideas"],
        answer: "The Projects section provides development project ideas and details.",
        link: "/projects",
    },
    {
        question: "What is Digest Info?",
        keywords: ["digest info", "digest"],
        answer: "Digest Info provides summarized and structured development insights.",
        link: "/digest-info",
    },
];
