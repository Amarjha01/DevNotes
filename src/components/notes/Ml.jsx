...
const notes = [
  {
    ...
    preview:
      "https://drive.google.com/file/d/1ru1y1FhQWOUwa4eEYidKK6F3hyyzfd51/preview",
    download:
      "https://drive.google.com/file/d/1ru1y1FhQWOUwa4eEYidKK6F3hyyzfd51/view?usp=sharing",
  ...
  },
  {
    ...
    preview:
      "https://drive.google.com/file/d/1du6gPvX-X-5htJ9gbwV3lWWv3KSGov_V/preview",
    download:
      "https://drive.google.com/file/d/1du6gPvX-X-5htJ9gbwV3lWWv3KSGov_V/view?usp=sharing",
  ...
  },
  {
    ...
    preview:
      "https://drive.google.com/file/d/1CgiZAVSAvNW5w3wcturyy-0OHnwOIBqt/preview",
    download:
      "https://drive.google.com/file/d/1CgiZAVSAvNW5w3wcturyy-0OHnwOIBqt/view?usp=sharing",
  ...
  },
  {
    ...
    preview:
      "https://drive.google.com/file/d/1j_iJ1SsL6lfIfVVTlrQ5fs-bx7NbAbap/preview",
    download:
      "https://drive.google.com/file/d/1j_iJ1SsL6lfIfVVTlrQ5fs-bx7NbAbap/view?usp=sharing",
...
const getBookmarks = () => {
  try {
    const saved = localStorage.getItem("mlBookmarkedNotes");
...
const setBookmarksLS = (data) => {
  localStorage.setItem("mlBookmarkedNotes", JSON.stringify(data));
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white px-6 md:px-20 py-24">
      ...
      <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center gap-4 mb-10">
        <input
          ...
          className="w-full sm:flex-1 px-4 py-2 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-pink-500"
        />
        <button
          onClick={() => setShowBookmarks(!showBookmarks)}
          className="px-4 py-2 rounded-lg bg-pink-600 hover:bg-pink-700 transition text-sm font-medium"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
        {filteredNotes.map((note, index) => (
          <motion.div
            ...
            className="bg-gray-900/60 border border-gray-700/50 rounded-2xl shadow-lg hover:shadow-pink-500/20 transition-all duration-300 overflow-hidden flex flex-col relative"
          >
            {/* 📑 Bookmark Button */}
            <button
